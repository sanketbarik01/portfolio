                ...
                <div className="space-y-6">
                    ...
                    <p className="text-muted-foreground">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                            ...
                            <a href="\projects\RESUME (1).pdf" className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300">Download CV
                            </a>
                        </div>
                </div>
